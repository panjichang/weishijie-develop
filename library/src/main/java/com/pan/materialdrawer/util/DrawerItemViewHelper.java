...
public class DrawerItemViewHelper {
    ...
    public View build() {
        ...
        if (mDivider) {
            ...
            divider.setBackgroundColor(UIUtils.getThemeColorFromAttrOrRes(mContext, com.pan.materialdrawer.R.attr.material_drawer_divider, com.pan.materialdrawer.R.color.material_drawer_divider));
