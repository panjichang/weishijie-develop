...
public abstract class BaseSecondaryDrawerItem<T> extends BaseDrawerItem<T> {
    ...
    protected int getColor(Context ctx) {
        int color;
        if (this.isEnabled()) {
            color = ColorHolder.color(getTextColor(), ctx, com.pan.materialdrawer.R.attr.material_drawer_secondary_text, com.pan.materialdrawer.R.color.material_drawer_secondary_text);
        } else {
    ...
    protected static class BaseViewHolder extends RecyclerView.ViewHolder {
        ...
        public BaseViewHolder(View view) {
            ...
            this.description = (TextView) view.findViewById(com.pan.materialdrawer.R.id.material_drawer_description);
        }
    }
}
