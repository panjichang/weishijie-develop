...
import com.pan.materialdrawer.model.interfaces.Iconable;
...
public abstract class BaseDrawerItem<T> extends AbstractDrawerItem<T> implements Nameable<T>, Iconable<T>, Tagable<T>, Typefaceable<T> {
    ...
    protected int getSelectedColor(Context ctx) {
        return ColorHolder.color(getSelectedColor(), ctx, com.pan.materialdrawer.R.attr.material_drawer_selected, com.pan.materialdrawer.R.color.material_drawer_selected);
    }
    ...
    protected int getColor(Context ctx) {
        ...
        if (this.isEnabled()) {
            ...
            color = ColorHolder.color(getDisabledTextColor(), ctx, com.pan.materialdrawer.R.attr.material_drawer_hint_text, com.pan.materialdrawer.R.color.material_drawer_hint_text);
        }
        return color;
    }
    ...
    protected int getSelectedTextColor(Context ctx) {
        return ColorHolder.color(getSelectedTextColor(), ctx, com.pan.materialdrawer.R.attr.material_drawer_selected_text, com.pan.materialdrawer.R.color.material_drawer_selected_text);
    }
    ...
    public int getIconColor(Context ctx) {
        int iconColor;
        if (this.isEnabled()) {
            iconColor = ColorHolder.color(getIconColor(), ctx, com.pan.materialdrawer.R.attr.material_drawer_primary_icon, com.pan.materialdrawer.R.color.material_drawer_primary_icon);
        } else {
            iconColor = ColorHolder.color(getDisabledIconColor(), ctx, com.pan.materialdrawer.R.attr.material_drawer_hint_icon, com.pan.materialdrawer.R.color.material_drawer_hint_icon);
        }
        return iconColor;
    }
    ...
    protected int getSelectedIconColor(Context ctx) {
        return ColorHolder.color(getSelectedIconColor(), ctx, com.pan.materialdrawer.R.attr.material_drawer_selected_text, com.pan.materialdrawer.R.color.material_drawer_selected_text);
    }
